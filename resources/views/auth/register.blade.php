                    ...
                    <form class="text-left" action="{{ route('register') }}" method="POST">
                        ...
                        <div class="form">
                            ...
                            <div id="email-field" class="field-wrapper input">
                                ...
                                <input id="email" name="email" type="text" value="" class="form-control @error('name') is-invalid @enderror" placeholder="Email" value="{{ old('email') }}">
                                @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div id="password-field" class="field-wrapper input mb-2">
                                <div class="d-flex justify-content-between">
                                    ...
                                    {{-- <a href="/cork/laravel/ltr/vertical-light-menu/authentication/pass_recovery_boxed" class="forgot-pass-link">Forgot Password?</a> --}}
                                </div>
                            ...
                            <div id="password-field" class="field-wrapper input mb-2">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-lock"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>
                                <input id="confirm_password" name="password_confirmation" type="password" class="form-control @error('password') is-invalid @enderror" placeholder="Confirm Password">
