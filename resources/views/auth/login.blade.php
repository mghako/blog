                        ...
                        @csrf
                            <div class="form">
                                ...
                                {{-- <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="username" name="username" type="text" class="form-control @error('email') is-invalid @enderror"" value="{{ old('email') }}" placeholder="e.g John_Doe">
                                    @error('email')
